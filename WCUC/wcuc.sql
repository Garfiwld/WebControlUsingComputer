...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2020 at 05:52 AM
...
('0', NULL, NULL, 'Offline', NULL),
('08-00-27-1E-D2-65', NULL, NULL, 'Offline', NULL),
('08-00-27-5A-44-2C', NULL, '4-1', 'Offline', NULL),
('08-00-27-5A-F5-F3', '192.168.1.106', '1-1', 'Login', '5804062616398'),
...
('25', NULL, NULL, 'Offline', NULL),
('26', NULL, NULL, 'Offline', NULL),
('27', NULL, NULL, 'Offline', NULL),
('28', NULL, NULL, 'Offline', NULL),
...
('36', NULL, NULL, 'Offline', NULL),
('37', NULL, NULL, 'Offline', NULL),
...
('C4-34-6B-62-A7-31', NULL, '8-3', 'Offline', NULL),
('C4-34-6B-62-A7-6D', NULL, '10-1', 'Offline', NULL),
('C4-34-6B-62-A7-71', NULL, '10-3', 'Offline', NULL),
('C4-34-6B-63-25-49', NULL, '11-1', 'Offline', NULL),
('C4-34-6B-63-25-4B', NULL, '8-1', 'Offline', NULL),
('C4-34-6B-63-25-4C', NULL, '11-3', 'Offline', NULL),
('C4-34-6B-64-0E-A3', NULL, '7-3', 'Offline', NULL),
('C4-34-6B-65-10-45', NULL, '7-1', 'Offline', NULL);
...
('5804062616398', '1', 'สาธร', 'โพธิ์พันธุ์', 'No'),
